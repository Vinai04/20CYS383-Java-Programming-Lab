...
public class FileTransferServer {
    ...
    public void start() {
        try {
            ...
            System.out.println("Server started. Listening on port 2444...");
    ...
    public static void main(String[] args) {
        String saveDirectory = "E:\\Class Materials\\SEMESTER 04\\Java\\IntelliJ\\FileTransferClient"; // Specify the desired save directory
